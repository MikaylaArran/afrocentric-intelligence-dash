...
const STATIC_DATA = {
  ...
  general: {
    ...
    watchPoints: [
      `🔴 ${TODAY_SHORT.toUpperCase()} DAY ${DAY_COUNT}: Court POSTPONED — three-way blame narrative; backlog clearing`,
  ...
  medscheme: {
    ...
    watchPoints: [
      `🔴 ${TODAY_SHORT.toUpperCase()} DAY ${DAY_COUNT}: Court POSTPONED — Medscheme counter-statement (5 Jun) on record; new date TBA`,
      "\ud83d\udfe2 27 MAY — Bonitas claims switched to Momentum (final Medscheme claims run was 26 May)",
