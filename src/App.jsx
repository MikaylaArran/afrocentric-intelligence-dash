...
const STATIC_DATA = {
  ...
  general: {
    ...
    oneLiner: "\ud83d\udd34 POST-HANDOVER DAY 29 (30 June): Bonitas blames Medscheme for ~10,000 outstanding matters; counter-narrative now live. Members still reporting disruptions; cancelled surgeries, 5-hr queues. 🔴 HIGH COURT POSTPONED (was 9–10 June) — New date TBA. \ud83d\udfe2 Lenacapavir LAUNCHED 5 JUNE 2026; Lilian Ngoyi Stadium, Secunda, 09h00; President Ramaphosa. \ud83d\udfe2 ACT.JO 120 ZAC (29 Jun close). ⚡ 30 June — 🔴 ACTIVO LONG STOP DATE IS TODAY (30 JUNE) — NO COMPLETION SENS ISSUED. Deal will lapse tonight unless extended in writing or completion announced. \ud83d\udd34 FY2025: R1.27bn basic loss, no dividend. \ud83d\udfe2 25 MAY — Netcare H1 2026: adj. HEPS +21.9% to 71.7c, revenue R13.3bn, dividend 44c (+22.2%); AI wearable wards pilot. \ud83d\udd34 1 June 2026 — Bonitas 40% revenue cliff hit permanently. ⚖️ NHI ConCourt — judgment DELIVERED 24 May 2026, no date set. \ud83d\udfe2 CMS Indaba CONCLUDED — Circular 10 directives fully operational.",
    themes: [
      {
      ...
      {
        theme: "\ud83d\udd34 DAY 29 POST-HANDOVER: Bonitas Blames Medscheme for ~10,000 Outstanding Matters — Counter-Narrative Now Live",
        sentiment: "NEGATIVE",
      ...
      {
        theme: "\ud83d\udfe2 ACT.JO — ~120 ZAC (29 Jun close); 52-Wk 110–223 ZAC (+97% from 61 ZAC All-Time Low)",
        sentiment: "CAUTIOUS",
        what: "ACT.JO at approximately 120 ZAC on 30 June 2026 (TradingView). +97% from the all-time low of 61 ZAC on 20 March 2026. 52-week range: 110–223 ZAC. Market cap approximately R737m. No new SENS since AGM results (11 May). Key pending SENS event: Activo disposal Long Stop Date 30 June 2026 (4 days away — TOMORROW); buyer FHC Group (Laboratórios Basi, Portugal); carrying value ~R1.1bn; proceeds earmarked to deleverage balance sheet. H1 2026 interim results SENS: 1 Sep 2026.",
        sources: [
          { name: "Investing.com NG", url: "https://ng.investing.com/equities/afrocentric-investment-corp-chart", date: "30 June 2026" },
          { name: "TradingView JSE:ACT", url: "https://www.tradingview.com/symbols/JSE-ACT/", date: "30 June 2026" },
          { name: "Moneyweb ACT SENS", url: "https://www.moneyweb.co.za/tools-and-data/click-a-company/ACT/", date: "30 June 2026" },
          { name: "AfroCentric investor centre", url: "https://www.afrocentric.za.com/investor-centre/", date: "May 2026" },
        ],
        representative_voice: "ACT ~120 ZAC (29 Jun close). 52-week range 110–223 ZAC. Activo Long Stop Date IS TODAY 30 JUNE — NO SENS YET is the key pending corporate event. (30 June 2026)",
      },
      {
    ...
    watchPoints: [
      "🔴 30 JUNE DAY 29: Court POSTPONED — three-way blame narrative; backlog clearing",
      ...
      "\ud83d\udfe2 ACT.JO — ~120 ZAC (29 Jun close); 52-wk range 110–223 ZAC; +71% from 61 ZAC all-time low",
  ...
  medscheme: {
    ...
    watchPoints: [
      "🔴 30 JUNE DAY 29: Court POSTPONED — Medscheme counter-statement (5 Jun) on record; new date TBA",
      "\ud83d\udfe2 27 MAY — Bonitas claims switched to Momentum (final Medscheme claims run was 26 May)",
  ...
  financial: {
    ...
    themes: [
      ...
      },
      {
        ...
        sentiment: "POSITIVE",
        what: "Momentum is the defining competitive winner of 2026. R100m+ budget, 744 new hires, 22 walk-in centres. Market share shifted 22%→30% from 1 June (completed) — SA's second-largest administrator after Discovery. H1 FY2026: headline earnings +8% to R3.56bn, NHE +8% to R3.695bn, HEPS +13% to 274.4c, interim dividend 110c (+29%). F2027 targets — R7bn NHE, 20% ROE — intact. ROE already at 24%, above the 20% target. Post-handover chaos (days 1–29) is a short-term operational risk; SLA recovery underway.",
    ...
    watchPoints: [
      ...
      "⚡ 30 June 2026 — Activo disposal Long Stop Date (4 days away — TOMORROW) — conditions precedent must be met; buyer FHC Group (Portugal); earnout up to R250m",
      "\ud83d\udfe2 ACT.JO ~120 ZAC (29 Jun close); 52-wk range 110–223 ZAC; +71% from 61 ZAC all-time low (20 Mar)",
  ...
  employer: {
    ...
    oneLiner: "\ud83d\udd34 DAY 29 POST-HANDOVER: Bonitas now blaming Medscheme for ~10,000 unresolved matters — reputational risk for outgoing administrator. \ud83d\udfe2 1 June handover completed. 5,000 jobs at risk — no S197 protection; S189 retrenchment notices watch in coming weeks. \ud83d\udfe2 Momentum hired 744 — Medscheme staff prioritised (15% absorption rate). \ud83d\udfe2 Sisonke win signals business still competitive. \ud83d\udfe2 Top Employer SA 2025 retained.",
    themes: [
      {
  ...
  competitors: {
    ...
    themes: [
      ...
      },
      {
        ...
        sources: [
          { name: "TradingView JSE:LHC", url: "https://www.tradingview.com/symbols/JSE-LHC/", date: "30 June 2026" },
          { name: "Moneyweb LHC SENS", url: "https://www.moneyweb.co.za/tools-and-data/click-a-company/LHC/", date: "30 June 2026" },
        ],
    ...
    watchPoints: [
      "🔴 30 JUNE DAY 29 — Court POSTPONED (was 9–10 Jun); Medscheme counter-statement 5 Jun; backlog clearing",
  ...
  return (
    <div className="fade">
      <div style={{ marginBottom: 24 }}>
        <div style={{ fontSize: 9, letterSpacing: "2px", color: T.muted, fontFamily: mono, marginBottom: 10 }}>TOP SIGNALS — 30 JUNE 2026</div>
      ...
      <div style={{ marginBottom: 20 }}>
        <div style={{ fontSize: 9, letterSpacing: "2px", color: T.muted, fontFamily: mono, marginBottom: 10 }}>MARKET LANDSCAPE — 30 JUNE 2026</div>
      ...
      <div style={{ background: T.surface, borderLeft: `3px solid ${T.border2}`, border: `1px solid ${T.border}`, padding: "14px 20px", marginBottom: 16 }}>
        <div style={{ fontSize: 9, letterSpacing: "2px", color: T.muted, marginBottom: 10, fontFamily: mono }}>
          {selected === "all" ? "COMPETITOR INTELLIGENCE SUMMARY — 30 JUNE 2026" : `${entity?.label?.toUpperCase()} — INTELLIGENCE SUMMARY`}
        </div>
      ...
      <div style={{ background: T.bg, minHeight: "100vh", fontFamily: font, color: T.text, fontSize: 13, transition: "background 0.2s, color 0.2s" }}>
        ...
        <div style={{ background: T.surface, borderBottom: `1px solid ${T.border}`, padding: "12px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div className="header-subtitle" style={{ fontSize: 9, color: T.muted, letterSpacing: "1.5px" }}>AfroCentric GROUP · NEWS & INTELLIGENCE MONITOR — JSE:ACT · 30 JUNE 2026</div>
          </div>
            ...
            <div className="fade">
              <div style={{ display: "flex", gap: 1, marginBottom: 16, background: T.border }}>
                {[
                  ...
                  { label: "LAST UPDATED",       value: "30 June 2026",          color: T.muted },
                ].map((s, i) => (
              ...
              <div style={{ background: T.surface, borderLeft: `3px solid ${T.green}`, border: `1px solid ${T.border}`, padding: "14px 20px", marginBottom: 16 }}>
                <div style={{ fontSize: 9, letterSpacing: "2px", color: T.muted, marginBottom: 10, fontFamily: mono }}>INTELLIGENCE SUMMARY — 30 JUNE 2026</div>
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        ...
        <div style={{ borderTop: `1px solid ${T.border}`, padding: "16px 20px", background: T.surface, marginTop: 24 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12, marginBottom: 10 }}>
            ...
            <span style={{ fontSize: 9, color: T.muted, letterSpacing: "1px", fontFamily: mono }}>SA HEALTH NEWS: LIVE · INTELLIGENCE TABS: UPDATED 30 JUNE 2026</span>
          </div>
