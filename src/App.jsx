...
const STATIC_DATA = {
  ...
  general: {
    ...
    themes: [
      ...
      {
        theme: "🟢 ACT.JO — Range 124–140 ZAC (27 May); 52-Wk 110–223 ZAC (+71% from 61 ZAC All-Time Low)",
        sentiment: "CAUTIOUS",
        what: "ACT.JO trading in the 124–140 ZAC range on 29 May 2026 — a recovery of +71% from the all-time low of 61 ZAC on 20 March 2026. 52-week range: 110–223 ZAC. Market cap approximately R736m–R981m. Key SENS events since March 2026: (1) 23 Apr — Revised Activo disposal terms; Long Stop Date extended to 30 June 2026; buyer FHC Group (Laboratórios Basi, Portugal); carrying value ~R1.1bn; proceeds earmarked to deleverage balance sheet. (2) 08 Apr — IAR + AGM notice. (3) 09 Mar — Board change. (4) 04 Mar — FY2025 summarised results. (5) 02 Mar — Trading statement. AGM held 11 May. H1 2026 results SENS: 1 Sep 2026.",
        sources: [
          { name: "Investing.com NG", url: "https://ng.investing.com/equities/afrocentric-investment-corp-chart", date: "29 May 2026" },
          { name: "TradingView JSE:ACT", url: "https://www.tradingview.com/symbols/JSE-ACT/", date: "29 May 2026" },
          { name: "Moneyweb ACT SENS", url: "https://www.moneyweb.co.za/tools-and-data/click-a-company/ACT/", date: "29 May 2026" },
          { name: "AfroCentric investor centre", url: "https://www.afrocentric.za.com/investor-centre/", date: "May 2026" },
        ],
        representative_voice: "ACT range 124–140 ZAC (28 May); 52-week range 110–223 ZAC. The Activo Long Stop Date 30 June is the key pending corporate event — completion unlocks balance sheet deleveraging. (TradingView/Investing.com, 29 May 2026)",
      },
      {
    ...
    watchPoints: [
      ...
      "⚡ 1 June 2026 — Bonitas handover to Momentum (3 days) — 40% revenue cliff",
      ...
      "⚠️ 29 May 2026 — 🔴 FASR regulatory submission deadline — TODAY 29 May — FINAL DAY",
      ...
      "🟢 ACT.JO — range 124–140 ZAC (27 May); 52-wk range 110–223 ZAC; +71% from 61 ZAC all-time low",
  ...
  medscheme: {
    ...
    watchPoints: [
      "🟢 27 MAY — Bonitas claims switched to Momentum (final Medscheme claims run was 26 May)",
      "⚡ 1 June 2026 — Bonitas operational handover (3 days)",
      "🆕 9–10 June 2026 — Medscheme High Court dates PROVISIONALLY SECURED; legal challenge heard AFTER handover",
      "⚡ 29 May 2026 — TODAY — DEADLINE: Medscheme final operational processes hand to PHA; FASR deadline same day",
  ...
  financial: {
    ...
    topVoices: [
      { type: "Investor", sentiment: "negative", quote: "No dividend, R1.59bn impairments, Bonitas ending in 3 days. H1 2026 interim results will be the ugliest numbers AfroCentric Group has ever reported." },
    ...
    watchPoints: [
      "⚡ 1 June 2026 — Bonitas revenue exits Medscheme's books (3 days)",
      "⚡ 30 June 2026 — Activo disposal Long Stop Date — completion deleverages balance sheet; buyer FHC Group (Portugal)",
      "🟢 ACT.JO range 124–140 ZAC (27 May); 52-wk range 110–223 ZAC; +71% from 61 ZAC all-time low (20 Mar)",
  ...
  nhi: {
    ...
    oneLiner: "⚖️ NHI ConCourt — public participation judgment RESERVED (7 May); no date set. 🔴 18 MAY — ConCourt struck down Certificate of Need (Sections 36–40 National Health Act) — unconstitutional; DoH says no direct NHI impact. 🟢 Motsoaledi APOLOGISED (16 May) for ConCourt judges impartiality remarks — full confidence in judiciary affirmed. 🟢 Lenacapavir HIV injection — 5 June launch (7 days); stocks deploying to 360 high-burden facilities NOW. ✅ CMS Indaba CONCLUDED (13-14 May) — Circular 10 fully operational; all administrators under governance expectations. ⚠️ FASR deadline 29 May — TODAY — DEADLINE. 🟢 AfroCentric CCMDD, GEMS and HIV portfolio — strongest NHI hedge in the group.",
    themes: [
      {
  ...
  employer: {
    ...
    watchPoints: [
      "⚡ 1 June 2026 — Bonitas handover — highest-risk moment for affected staff (3 days)",
  ...
  competitors: {
    ...
    oneLiner: "🟢 25 MAY — Netcare H1 2026: adj. HEPS +21.9% to 71.7c, revenue R13.3bn, dividend 44c (+22.2%); AI wearable wards pilot described as world's biggest rollout. 🟢 Melanie Da Costa — Netcare CEO Designate from 1 June 2026. 🔴 18 MAY — NFO ruled against Discovery Life on cancer SIB claim; sector-wide policy wording review likely. 🔴 18 MAY — ConCourt struck down Certificate of Need (Sections 36–40 National Health Act) — major threat to private healthcare expansion removed. 🟢 Discovery H1 FY2026: NHE +27% to R5.75bn — record results; Vitality AI + Google Cloud globally launched. 🟢 20 MAY — Discovery rebrands Africa employer business to Global Health Solutions; continental ASO expansion. 🔴 Discovery Vitality Sleep Rewards live (7 May) — world's first sleep pillar; Oura Ring 4 fundable. ⚡ 1 June 2026 — Bonitas to Momentum (3 days); market share 22%→30%; PHA takes managed care; fraudulent documents allegation unresolved. 🔴 Sizwe Hosmed: curator Ian Fleming, solvency 30%, amalgamation being explored. 🟢 Fedhealth+Sanlam 'Built Different' live Jan 2026; BestMed 6.8% lowest open scheme increase. ✅ CMS Indaba CONCLUDED (13-14 May) — Circular 10 directives fully operational.",
    themes: [
      {
      ...
      },
      {
        ...
        what: "Life Healthcare (JSE:LHC) — SA's second-largest hospital group — released H1 FY2026 interim results today, 29 May 2026. Life operates 63 facilities across South Africa, Botswana and Europe (Alliance Medical sold). The group is strategically pivoting from traditional acute hospitals to day-clinics, non-acute services and out-of-pocket payers (MyLife Clinic: R300 consultations). Current price ~R12.40; 52-week range R10.14–R15.60. CEO Peter Wharton-Hood leads the group. Key metrics to watch: paid patient days, EBITDA margin, southern Africa revenue growth. Context: Netcare's H1 2026 showed +4.8% revenue — Life's results will confirm whether private hospital demand is sector-wide or Netcare-specific. Directly relevant to Medscheme/AfroCentric as a major provider network counterpart.",
        sources: [
          { name: "TradingView JSE:LHC", url: "https://www.tradingview.com/symbols/JSE-LHC/", date: "29 May 2026" },
          { name: "Moneyweb LHC SENS", url: "https://www.moneyweb.co.za/tools-and-data/click-a-company/LHC/", date: "29 May 2026" },
          { name: "Life Healthcare", url: "https://www.lifehealthcare.co.za/", date: "29 May 2026" },
        ],
    ...
    watchPoints: [
      ...
      "⚡ 1 June 2026 — Melanie Da Costa becomes Netcare CEO Designate; Bonitas to Momentum (3 days)",
      ...
      "⚡ 1 June 2026 — Bonitas to Momentum (3 days) — watch for member experience issues post-handover",
...
const COMPETITOR_CARDS = [
  ...
  { id: "Momentum",      label: "Momentum",       metric: "22%→30% share",    sub: "NHE +8% R3.7bn · ROE 24%",       sentiment: "POSITIVE",  note: "Bonitas live 1 June — 3 days" },
  ...
  return (
    <div className="fade">
      ...
      <div style={{ marginBottom: 24 }}>
        <div style={{ fontSize: 9, letterSpacing: "2px", color: T.muted, fontFamily: mono, marginBottom: 10 }}>TOP SIGNALS — 29 MAY 2026</div>
      ...
      <div style={{ marginBottom: 20 }}>
        <div style={{ fontSize: 9, letterSpacing: "2px", color: T.muted, fontFamily: mono, marginBottom: 10 }}>MARKET LANDSCAPE — 29 MAY 2026</div>
      ...
      <div style={{ background: T.surface, borderLeft: `3px solid ${entity?.color || T.green}`, border: `1px solid ${T.border}`, padding: "14px 20px", marginBottom: 16 }}>
        <div style={{ fontSize: 9, letterSpacing: "2px", color: T.muted, marginBottom: 10, fontFamily: mono }}>
          {selected === "all" ? "COMPETITOR INTELLIGENCE SUMMARY — 29 MAY 2026" : `${entity?.label?.toUpperCase()} — INTELLIGENCE SUMMARY`}
        </div>
      ...
      <div style={{ background: T.bg, minHeight: "100vh", fontFamily: font, color: T.text, fontSize: 13, transition: "background 0.2s, color 0.2s" }}>
        ...
        <div style={{ background: T.surface, borderBottom: `1px solid ${T.border}`, padding: "12px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div className="header-subtitle" style={{ fontSize: 9, color: T.muted, letterSpacing: "1.5px" }}>AfroCentric GROUP · NEWS & INTELLIGENCE MONITOR — JSE:ACT · 29 MAY 2026</div>
          </div>
            ...
            <div className="fade">
              <div style={{ display: "flex", gap: 1, marginBottom: 16, background: T.border }}>
                {[
                  ...
                  { label: "LAST UPDATED",       value: "29 May 2026",          color: T.muted },
                ].map((s, i) => (
              ...
              <div style={{ background: T.surface, borderLeft: `3px solid ${T.green}`, border: `1px solid ${T.border}`, padding: "14px 20px", marginBottom: 16 }}>
                <div style={{ fontSize: 9, letterSpacing: "2px", color: T.muted, marginBottom: 10, fontFamily: mono }}>INTELLIGENCE SUMMARY — 29 MAY 2026</div>
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        ...
        <div style={{ borderTop: `1px solid ${T.border}`, padding: "16px 20px", background: T.surface, marginTop: 24 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12, marginBottom: 10 }}>
            ...
            <span style={{ fontSize: 9, color: T.muted, letterSpacing: "1px", fontFamily: mono }}>SA HEALTH NEWS: LIVE · INTELLIGENCE TABS: UPDATED 29 MAY 2026</span>
          </div>
