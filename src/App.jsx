    ...
    themes: [
      {
        ...
        watchPoints: [
          `⚡ CMS s44 findings due END-AUGUST — ~${Math.max(0, Math.ceil((new Date(2026,7,31) - TODAY) / MS_DAY))} days away. Adverse findings on the 2022/2024 tenders would retrospectively validate Medscheme’s core allegations even though it lost the litigation`,
