    ...
    themes: [
      {
        ...
        watchPoints: [
          `⚡ INTERIM RESULTS 1 SEPTEMBER 2026 (SENS; presentation 2 Sep) — ${Math.max(0, Math.ceil((new Date(2026,8,1) - TODAY) / MS_DAY))} days away. First results carrying a full period of the Bonitas revenue cliff, and the likely forum for a formal Activo update`,
